...
1. Update `PackageVersion` in all three files to the new version (e.g. `1.8.2`).
...
> wingetcreate update TRGamer-tech.FluentTaskScheduler --version 1.8.2 `
>   --urls "https://github.com/TRGamer-tech/FluentTaskScheduler/releases/download/V1.8.2/Setup-x64.msi|x64|msi" `
>          "https://github.com/TRGamer-tech/FluentTaskScheduler/releases/download/V1.8.2/Setup-arm64.msi|arm64|msi" `
>   --submit
> ```
