...
namespace FluentTaskScheduler.Tests
{
    ...
    public class XPathLiteralTests
    {
        ...
        {
            Assert.Equal("'My Task'", TaskDefinitionBuilder.ToXPathLiteral("My Task"));
        }

        [Fact]
        public void ValueContainingSingleQuote_IsWrappedInDoubleQuotes()
        {
            Assert.Equal("\"O'Brien's backup\"", TaskDefinitionBuilder.ToXPathLiteral("O'Brien's backup"));
        }

        [Fact]
        public void ValueContainingBothQuoteTypes_UsesConcat()
        {
            string result = TaskDefinitionBuilder.ToXPathLiteral("a'b\"c");
        ...
        {
            Assert.Equal("''", TaskDefinitionBuilder.ToXPathLiteral(""));
        }

        [Fact]
        public void NullValue_DoesNotThrow()
        {
            Assert.Equal("''", TaskDefinitionBuilder.ToXPathLiteral(null!));
        }
    }
}
