...
6. Fix Issue #13 by adding a filter by category and tag to the dashboard.
7. Fix Issue #14 by removing the warning when the apps runs as admin.
8. Fix Reordering triggers and actions.
9. Fix Network selection.
10. Add helpful tooltips to all UI elements in the add / edit dialog.
11. Fix the annoying bug that the Scrolling gets reset to the top everytime you miss a UI element in the add / edit dialog.
